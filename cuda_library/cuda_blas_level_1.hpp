...
namespace aks
{
    namespace cuda_blas 
    {
        int abs_max_index(cuda_blas_manager const& mgr, cuda_multi_dim_vector<double, 1> const& xs)
        {
        ...
        int abs_min_index(cuda_blas_manager const& mgr, cuda_multi_dim_vector<double, 1> const& xs)
        {
            cuda_blas_manager::status_type status = cuda_blas_manager::success_value;
            int result = 0;
        ...
        double abs_sum(cuda_blas_manager const& mgr, cuda_multi_dim_vector<double, 1> const& xs)
        {
            cuda_blas_manager::status_type status = cuda_blas_manager::success_value;
            double result = 0;
        ...
        double dot(cuda_blas_manager const& mgr, cuda_multi_dim_vector<double, 1> const& xs, cuda_multi_dim_vector<double, 1> const& ys)
        {
        ...
        double norm_sq(cuda_blas_manager const& mgr, cuda_multi_dim_vector<double, 1> const& xs)
        {
            cuda_blas_manager::status_type status = cuda_blas_manager::success_value;
            double result = 0;
        ...
        cuda_multi_dim_vector<double, 1>& scale_in_place(cuda_blas_manager const& mgr, cuda_multi_dim_vector<double, 1>& xs, double const alpha)
        {
            cuda_blas_manager::status_type status = cuda_blas_manager::success_value;
